...
export MQTT_DISCOVERY_DATA_TOPIC=$(bashio::config 'advanced.mqtt_discovery_data_topic')
export MQTT_DATA_ROOT_TOPIC=$(bashio::config 'advanced.mqtt_data_root_topic')
